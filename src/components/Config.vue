    ...
    <a-space direction="vertical" style="width: 100%" v-if="!loading">
      ...
      <p>
        Access Token of your canvas account. (<a
          ...
          target="_blank"
          >Tutorial for getting an access token</a
        >)
      </p>
      <a-input
        v-model:value="token"
      ...
      <a-typography-title :level="3"
        >Time format
        <a-badge count="v 1.5" :number-style="{ backgroundColor: '#52c41a' }"
      /></a-typography-title>
      ...
      <a-input
        ...
        placeholder="strftime string"
        v-if="time_format_mode == 'strftime'"
      />
      ...
      <a-upload
        v-model:file-list="background_filelist"
        list-type="picture"
      ...
      <a-button type="primary" @click="force_reload" :loading="reload_loading"
        >Force Reload From Disk</a-button
      >
      <a-button type="primary" @click="verify" :loading="verify_loading"
        >Verify Configuration</a-button
      >
      <a-button
        type="primary"
        danger
        @click="remove_userdata"
        :loading="remove_userdata_loading"
        >Remove all user data</a-button
      >
      <a-alert
        message="Warning"
      ...
      <a-row justify="center" style="margin-top: 30px">
        <a-button type="primary" @click="submit" :loading="submit_loading"
          >Save</a-button
        >
      </a-row>
    </a-space>
